...
/* CEM_Lock_AtomicService_pubsub_subscriber.cxx
...
rtiddsgen -language C++11 -example <arch> CEM_Lock_AtomicService_pubsub.idl

Example subscription of type VechicleSpeed automatically generated by 
...
int process_data(dds::sub::DataReader<VechicleSpeed>& reader)
{
    // Take all samples
    int count = 0;
    dds::sub::LoanedSamples<VechicleSpeed> samples = reader.take();
...
int GearProcessData(dds::sub::DataReader<GearIndication>& reader) {
...
int subscriber_main(int domain_id, int sample_count)
{
    ...
    dds::topic::Topic<VechicleSpeed> topic(participant, "VechicleSpeed_Topic");

    // Create a DataReader with default Qos (Subscriber created in-line)
    dds::sub::DataReader<VechicleSpeed> reader(dds::sub::Subscriber(participant), topic);
    ...
    // process gear
    dds::topic::Topic<GearIndication> gearTopic(participant, "GearIndication_Topic");

    // Create a DataReader with default Qos (Subscriber created in-line)
    dds::sub::DataReader<GearIndication> gearReader(dds::sub::Subscriber(participant), gearTopic);
    dds::sub::cond::ReadCondition gear_read_condition(
        gearReader,
        dds::sub::status::DataState::any(),
